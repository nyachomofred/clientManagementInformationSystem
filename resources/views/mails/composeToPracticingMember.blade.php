 ...
 <section class="content">
      ...
      @endif
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">This email shall be received by [{{$totalclients}}] practicing members  <a type="button" class="btn btn-link" data-toggle="modal" data-target=".bd-example-modal-lg">View recipients</a> </h3>
            </div>
                <form method="POST" action="{{route('mails.composeToPracticingMemberCreate')}}" enctype="multipart/form-data">
                @csrf
                    <!-- /.box-header -->
                    <div class="box-body">
