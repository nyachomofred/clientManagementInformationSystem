      ...
      @endif
          ...
          <div class="box box-primary">
           <div class="box-header with-border" style="background-color: #2bbbad !important;color:white;text-transform:uppercase;">
             <center> <h3 class="box-title">Compose New Message . This message will be received by only selected people</h3></center>
            </div>
                <form method="POST" action="{{route('mails.createbarner')}}" enctype="multipart/form-data" class="form-horizontal">
                @csrf
                    <!-- /.box-header -->
                <div class="modal-body" style="color:#9e9e9e !important;">

                    <div class="form-group">
                       <label class="col-sm-2 control-label">Select Recipient</label>
                       <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Attach an  Image</label>
                         <div class="col-sm-10">
                            <div class="input-group control-group increment" >
                                <input type="file" name="a_file[]" class="form-control" multiple required>
