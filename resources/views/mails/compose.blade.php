      ...
      @endif
          ...
          <div class="box box-primary">
            <div class="box-header with-border" style="background-color: #2bbbad !important;color:white;text-transform:uppercase;">
                <center><h3 class="box-title"> <a href="{{route('mails.index')}}"> <i class="fa fa-backward"></i>Go Back</a> &nbsp; &nbsp; Compose New Message . This message will be received by only selected people</h3></center>
            </div>
