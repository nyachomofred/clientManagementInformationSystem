...
<section class="content">
      ...
      @endif
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Compose New Message [This message shall be received by {{$fullmembers}} Associate members] <a href="#" class="btn btn-link" data-toggle="modal" data-target="#modal-default">View Recipient</a></h3>

            </div>
            <form method="POST" action="{{route('messages.sendToAssociate')}}">
           @csrf
            <div class="box-body">
